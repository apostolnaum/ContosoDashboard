...
namespace ContosoDashboard.Migrations
{
    ...
    [Migration("20260518075653_AddDocumentManagement")]
            ...
            modelBuilder.Entity("ContosoDashboard.Models.Announcement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedByUserId = 1,
                            ExpiryDate = new DateTime(2025, 1, 31, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
            ...
            modelBuilder.Entity("ContosoDashboard.Models.Document", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "UploadedDate")
                        .HasDatabaseName("IX_Document_ProjectId_UploadedDate");

                    b.HasIndex("UserId", "UploadedDate")
            ...
            modelBuilder.Entity("ContosoDashboard.Models.DocumentActivityLog", b =>
                {
                    ...
                    b.HasIndex("DocumentId", "ActivityDate")
            ...
            modelBuilder.Entity("ContosoDashboard.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = 1,
                            TargetCompletionDate = new DateTime(2025, 3, 2, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("ContosoDashboard.Models.ProjectMember", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProjectMemberId = 1,
                            AssignedDate = new DateTime(2024, 12, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            ProjectId = 1,
                            Role = "TeamLead",
                            UserId = 3
                        },
            ...
            modelBuilder.Entity("ContosoDashboard.Models.TaskItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 12, 12, 0, 0, 0, 0, DateTimeKind.Utc),
                            Priority = 2,
                            ProjectId = 1,
                            Status = 2,
