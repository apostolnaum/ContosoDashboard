    ...
    public partial class AddDocumentManagement : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "IT", "System Administrator", "admin@contoso.com", true, true, "Administrator", null, null, null, 3 },
                    { 2, 0, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Engineering", "Camille Nicole", "camille.nicole@contoso.com", true, true, "Project Manager", null, null, null, 2 },
                    { 3, 0, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Engineering", "Floris Kregel", "floris.kregel@contoso.com", true, true, "Team Lead", null, null, null, 1 },
                    { 4, 0, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Engineering", "Ni Kang", "ni.kang@contoso.com", true, true, "Software Engineer", null, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "Announcements",
                columns: new[] { "AnnouncementId", "Content", "CreatedByUserId", "ExpiryDate", "IsActive", "PublishDate", "Title" },
                values: new object[] { 1, "Welcome to the new ContosoDashboard application. This platform will help you manage your tasks and projects more efficiently.", 1, new DateTime(2025, 1, 31, 0, 0, 0, 0, DateTimeKind.Utc), true, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Welcome to ContosoDashboard" });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "CreatedDate", "Description", "Name", "ProjectManagerId", "StartDate", "Status", "TargetCompletionDate", "UpdatedDate" },
                values: new object[] { 1, new DateTime(2024, 12, 2, 0, 0, 0, 0, DateTimeKind.Utc), "Internal employee productivity dashboard", "ContosoDashboard Development", 2, new DateTime(2024, 12, 2, 0, 0, 0, 0, DateTimeKind.Utc), 1, new DateTime(2025, 3, 2, 0, 0, 0, 0, DateTimeKind.Utc), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 2, 0, 0, 0, 0, DateTimeKind.Utc), 1, "TeamLead", 3 },
                    { 2, new DateTime(2024, 12, 2, 0, 0, 0, 0, DateTimeKind.Utc), 1, "Developer", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 2, new DateTime(2024, 12, 2, 0, 0, 0, 0, DateTimeKind.Utc), "Create entity relationship diagram and database design", new DateTime(2024, 12, 12, 0, 0, 0, 0, DateTimeKind.Utc), 2, 1, 2, "Design database schema", new DateTime(2024, 12, 12, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 2, 4, 2, new DateTime(2024, 12, 7, 0, 0, 0, 0, DateTimeKind.Utc), "Set up Microsoft Entra ID authentication", new DateTime(2025, 1, 6, 0, 0, 0, 0, DateTimeKind.Utc), 3, 1, 1, "Implement authentication", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 3, 4, 2, new DateTime(2024, 12, 12, 0, 0, 0, 0, DateTimeKind.Utc), "Design user interface mockups for all main pages", new DateTime(2025, 1, 11, 0, 0, 0, 0, DateTimeKind.Utc), 1, 1, 0, "Create UI mockups", new DateTime(2024, 12, 12, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_DocumentShare_Document_User",
                table: "DocumentShares",
